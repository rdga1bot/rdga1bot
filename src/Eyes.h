...
public:
    ...
    struct MinimapDot {
        ...
        bool  selected; // true = вибраний через /target (видно фіолетовий ореол)
    };
    ...
    float m_minimap_dot_area_min  = 2.0f;// мін площа контуру (знижено 4→2 для малих точок у підземеллях)
